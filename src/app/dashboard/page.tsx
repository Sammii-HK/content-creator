...
export default function Dashboard() {
  ...
  const fetchData = async () => {
    try {
      ...
      // Fetch videos - include all videos if no persona selected, or filter by persona
      ...
      if (response.ok) {
        ...
        console.log('Fetched videos:', data.broll?.length || 0, 'total');
                        ...
                        <CardContent className="p-6">
                          <div className="flex flex-col gap-4">
                            ...
                            <Button
                              variant="ghost"
                              size="sm"
                              className="w-fit -ml-2 group-hover:text-primary"
                            >
                              Get started
                        ...
                        <CardContent className="p-6">
                          <div className="flex flex-col gap-4">
                            ...
                            <Button
                              variant="ghost"
                              size="sm"
                              className="w-fit -ml-2 group-hover:text-success"
                            >
                              Start editing
                              <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" />
                            </Button>
                        ...
                        <CardContent className="p-6">
                          <div className="flex flex-col gap-4">
                            ...
                            <Button
                              variant="ghost"
                              size="sm"
                              className="w-fit -ml-2 group-hover:text-warning"
                            >
                              Create images
                              <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" />
                            </Button>
                  ...
                  <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                      ...
                      <Card>
                        <CardContent className="flex flex-col items-center justify-center py-20">
                          ...
                          <p className="mb-8 max-w-md text-center text-foreground-muted">
                            Upload your first video to start creating AI-powered content with
                            unlimited storage
                          </p>
                          <Link href="/dashboard/upload">
                            <Button size="lg">
                        ...
                        <CardContent>
                          <div className="space-y-4">
                            {videos.slice(0, 5).map((video) => (
                              <div
                                key={video.id}
                                className="flex items-center justify-between rounded-lg border border-border p-4 transition-colors hover:bg-background-secondary"
                              >
                    ...
                    <Card>
                      <CardHeader>
                        ...
                        <p className="text-sm text-foreground-muted">
                          Manage your AI-powered content voices
                        </p>
                      </CardHeader>
                      <CardContent>
                        <div className="space-y-4">
                              ...
                              <CardContent className="p-4">
                                <div className="flex items-center gap-4">
                                  ...
                                  <div className="flex-1">
                                    ...
                                    <p className="text-sm text-foreground-muted">
                                      Build AI that matches your voice
                                    </p>
                                  </div>
