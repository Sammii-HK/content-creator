...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        default:
          'bg-primary text-primary-foreground shadow-soft hover:bg-primary-hover hover:shadow-elevated active:scale-[0.98]',
        destructive:
          'bg-destructive text-destructive-foreground shadow-soft hover:bg-destructive/90 hover:shadow-elevated active:scale-[0.98]',
        outline:
          'border border-border bg-background text-foreground shadow-soft hover:bg-background-secondary hover:shadow-elevated active:scale-[0.98]',
        secondary:
          'bg-background-secondary text-foreground shadow-soft hover:bg-background-tertiary hover:shadow-elevated active:scale-[0.98]',
        ghost: 'text-foreground hover:bg-background-secondary/70 active:scale-[0.98]',
